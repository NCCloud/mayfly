...
func (_mock *MockScheduler) CreateOrUpdateOneTimeTask(tag string, at time.Time, task func() error) error {
	...
	var r0 error
	if returnFunc, ok := ret.Get(0).(func(string, time.Time, func() error) error); ok {
		r0 = returnFunc(tag, at, task)
	} else {
		r0 = ret.Error(0)
	}
	return r0
...
func (_mock *MockScheduler) CreateOrUpdateRecurringTask(tag string, cron string, task func() error) error {
	ret := _mock.Called(tag, cron, task)
	...
	var r0 error
	if returnFunc, ok := ret.Get(0).(func(string, string, func() error) error); ok {
		r0 = returnFunc(tag, cron, task)
	} else {
		r0 = ret.Error(0)
	}
	return r0
